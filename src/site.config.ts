...
const config: SiteConfig = {
  ...
  site: 'https://deployfriday.dev',
  // The name of your site, used in the title and for SEO.
  title: 'Deploy Friday',
  // The description of your site, used for SEO and RSS feed.
  description:
    'Mainly posts about development. Sometimes other things too.',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Goutham Pai',
  // Keywords for SEO, used in the meta tags.
  tags: ['code', 'development', 'software', 'microsoft', 'dotnet'],
  ...
  socialLinks: {
    github: 'https://github.com/gouthampai',
    email: 'goutham.r.pai@gmail.com',
    linkedin: 'https://www.linkedin.com/in/gouthampai/',
